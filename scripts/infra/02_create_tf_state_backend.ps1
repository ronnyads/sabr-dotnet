...
# Use compact JSON generated by PowerShell to avoid quoting issues in aws.exe.
$sseConfig = @{
  Rules = @(
    @{
...
aws s3api put-bucket-encryption --bucket $BucketName --server-side-encryption-configuration $sseConfig | Out-Null
