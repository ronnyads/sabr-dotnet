...
public sealed class AdminPlansController : ControllerBase
{
    ...
    {
        var result = await _adminPlanService.ListAsync(skip, limit, search, isActive, cancellationToken);
    ...
    public async Task<IActionResult> GetById(
        ...
        CancellationToken cancellationToken = default)
    {
        var result = await _adminPlanService.GetByIdAsync(planId, cancellationToken);
        if (!result.Succeeded || result.Data == null)
            return MapError(result.Errors);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _adminPlanService.CreateAsync(request, actorId, cancellationToken);
        if (!result.Succeeded || result.Data == null)
            return MapError(result.Errors);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _adminPlanService.UpdateAsync(planId, request, actorId, cancellationToken);
        if (!result.Succeeded || result.Data == null)
            return MapError(result.Errors);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _adminPlanService.DeactivateAsync(planId, actorId, cancellationToken);
        if (!result.Succeeded)
            return MapError(result.Errors);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _adminPlanService.ReplaceCatalogsAsync(planId, request, actorId, cancellationToken);
        if (!result.Succeeded || result.Data == null)
            return MapError(result.Errors);
