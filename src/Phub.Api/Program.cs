...
builder.Services.AddScoped<SupplierWalletService>();
builder.Services.AddScoped<SupplierWithdrawalService>();
...
builder.Services.AddScoped<IMarketplaceListingAdapter, MercadoLivreLegacyListingAdapter>();
