...
namespace Phub.Infrastructure.Migrations
{
    ...
    [Migration("20260216041354_AlignSkuUppercaseAndDraftConstraints")]
    partial class AlignSkuUppercaseAndDraftConstraints
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("products", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_products_sku_format", "\"sku\" ~ '^[A-Z0-9][A-Z0-9\\\\-_/]{0,63}$'");
                        });
                });
            ...
            modelBuilder.Entity("Phub.Domain.Entities.ProductCatalog", b =>
                {
                    ...
                    b.ToTable("product_catalogs", null, t =>
                        {
                            t.HasCheckConstraint("ck_product_catalogs_sku_format", "\"product_sku\" ~ '^[A-Z0-9][A-Z0-9\\\\-_/]{0,63}$'");
                        });
                });
            ...
            modelBuilder.Entity("Phub.Domain.Entities.ProductPriceHistory", b =>
                {
                    ...
                    b.ToTable("product_price_history", null, t =>
                        {
                            t.HasCheckConstraint("ck_product_price_history_sku_format", "\"product_sku\" ~ '^[A-Z0-9][A-Z0-9\\\\-_/]{0,63}$'");
                        });
                });
                    ...
                    b.ToTable("publications", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_publications_sku_format", "\"product_sku\" ~ '^[A-Z0-9][A-Z0-9\\\\-_/]{0,63}$'");
                        });
                });
